...
export default function UploadLayout({ children }) {
    ...
    return (
        <div className="dark:bg-transparent relative min-h-screen">
            <div className={`fixed inset-y-0 left-0 transition-transform duration-300 z-20 
            ...
            <div className="flex items-center p-4 pl-10 border-b border-stone-700/50">
                ...
                >
                    {!isShowing ?
                        ...
                        :
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-bar-left"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 12l10 0" /><path d="M4 12l4 4" /><path d="M4 12l4 -4" /><path d="M20 4l0 16" /></svg>}
                </button>
                <h1 className="text-stone-400 text-2xl">Upload</h1>
